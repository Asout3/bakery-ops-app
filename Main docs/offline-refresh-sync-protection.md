...
3. Do not change service worker production registration flow without validating offline refresh; development currently clears/unregisters service workers by design.
