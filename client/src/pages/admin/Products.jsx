              ...
              <tbody>
                {products.map((product) => (
                  <tr key={product.id}>
                    ...
                    <td>{product.unit}</td>
                    <td>
                      <span className={`badge ${product.is_pending_sync ? 'badge-warning' : product.is_active ? 'badge-success' : 'badge-danger'}`}>
                        {product.is_pending_sync ? 'Pending Sync' : product.is_active ? 'Active' : 'Inactive'}
                      </span>
                    </td>
                    <td>
                      <button
          ...
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            ...
            <form onSubmit={handleSubmit} className="modal-body">
              ...
              <div className="modal-footer">
                ...
                <button type="submit" className="btn btn-primary" disabled={saving}>{saving ? 'Saving...' : editingProduct ? 'Update' : 'Create'} Product</button>
              </div>
            </form>
          </div>
        </div>
